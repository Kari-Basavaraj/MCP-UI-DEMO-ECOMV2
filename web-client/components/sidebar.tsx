    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-2 px-4 py-4 border-b border-border/30">
          ...
          <span className="text-sm font-semibold tracking-tight">MCP</span>
        </div>

        {/* MCP Servers section */}
        <div className="flex-1 overflow-y-auto py-3 px-3">
          <div className="text-[10px] font-semibold text-muted-foreground/60 uppercase tracking-wider px-1 mb-2">
            MCP Servers
          </div>
          <button
